...
def preparation_time_in_minutes(number_of_layers):
    ...
    :return: int - time spent for preparation of lasagna.

    This function takes one integer representing the number of layers and calculates the preparation time spent.
    """
